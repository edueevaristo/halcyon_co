      ...
      <div class="landing-content">
        ...
        <div class="button-group">
          <router-link to="/login" class="btn-primary">
            <img src="@/assets/icons/sign-in.svg" alt="">Entrar
          </router-link>
...
.landing-page {
  ...
  align-items: center;
  background: linear-gradient(135deg, #141414 0%, #141414 50%, #9400ef 100%);
  position: relative;
  overflow: hidden;
}
...
h1 {
  font-size: 2rem;
  font-weight: 700;
  background: linear-gradient(90deg, #ff007f, #c800ff);
...
.btn-secondary {
  border-radius: 14px;
  border: 1px solid rgba(225, 12, 255, 0.50);
  background: #FFF;
  color: #a100ff;
}

.btn-primary:hover {
  background: linear-gradient(90deg, #c800ff, #ff007f);
}
